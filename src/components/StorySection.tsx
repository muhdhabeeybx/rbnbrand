...
export function StorySection() {
  return (
    <section className="min-h-screen flex flex-col lg:flex-row">
      {/* Text content */}
      <div className="flex-1 bg-black text-white p-8 lg:p-16 flex items-center">
        <div className="max-w-lg mx-auto lg:mx-0">
          ...
          <p className="text-base lg:text-lg mb-8 leading-relaxed opacity-75">
      ...
      <div className="flex-1 relative">
        ...
        <div className="absolute bottom-8 left-8 text-white">
          <p className="text-sm font-medium mb-1">Nurain</p>
          <p className="text-xs opacity-75">Founder & Creative Director</p>
        </div>
      </div>
    </section>
  );
